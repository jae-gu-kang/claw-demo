...
// **v1.10(200 kg급 예제)부터 0.14~0.22/0.02다** — 연료 25 kg·0.001 격자 실측 h100 M0.082~0.284 · h1000 M0.086~0.285 ·
// h3000 M0.097~0.283(공통을 안쪽으로 반올림해 M0.10~0.28 — 추진 1.45배 반영). 아래 끝은 α가 아니라 **나선 배가 시간**이 정했다: 느린 기체는 경로 시간
// 규모가 짧아 나선 발산도 빠르고, M0.12·h3000이 14 s로 판정선(20 s) 밖이다(engine test_profile_shipped_example.py).
// 아래는 구 합성 기체(1200 kg) 시절의 기록이다 — 그때 0.30~0.55/0.05가 세 고도 전부 안이었다(아래가 α, 위가 스로틀):
...
//
// 세 고도·연료(지금 25 kg — 구 기체 200 kg)는 위 엔벨로프를 **잰 조건**이라 마하와 같이 묶여 있다 —
...
export const DEFAULT_GRID = {
  machFrom: 0.14, machTo: 0.22, machStep: 0.02,
  alts: [100, 1000, 3000], fuels: [25],
};

/** 기본 격자의 이름 붙은 케이스 — 실행 순서는 서펜타인(인접 트림 시드). 인자 없이 부르면 위 폴백 15건,
