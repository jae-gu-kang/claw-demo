...
function WorldTab({ deps }) {
  const canvasRef = reactExports.useRef(null);
  const [note, setNote] = reactExports.useState("초기화 중…");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { font: "12px/1.6 system-ui", color: "var(--muted)" }, children: note })
  ] });
}
function mount(container, deps = {}) {
  ...
  try {
    ...
    root.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorldTab, { deps }) })
    );
  } catch (e) {
    root?.unmount();
    host.remove();
