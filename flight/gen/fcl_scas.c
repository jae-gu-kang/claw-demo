                   ...
                   double *out_scas_roll_sat, double *out_scas_yaw_sat)
{
    ...
    if ((scas_pitch_pid_axis > prm->scas_pitch_pid_out_hi && scas_pitch_pid_inc > 0.0) || (scas_pitch_pid_axis < prm->scas_pitch_pid_out_lo && scas_pitch_pid_inc < 0.0)) {
    ...
    if ((scas_roll_pid_axis > prm->scas_roll_pid_out_hi && scas_roll_pid_inc > 0.0) || (scas_roll_pid_axis < prm->scas_roll_pid_out_lo && scas_roll_pid_inc < 0.0)) {
