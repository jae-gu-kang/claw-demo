...
typedef struct {
    ...
    double scas_pitch_pid_out_lo;       /* 출력·적분기 클램프 하한 (안티와인드업) */
    double scas_pitch_pid_out_hi;       /* 출력·적분기 클램프 상한 (안티와인드업) */
    double scas_pitch_sat_lo;           /* 하한 */
    double scas_pitch_sat_hi;           /* 상한 */
    double scas_roll_pid_out_lo;        /* 출력·적분기 클램프 하한 (안티와인드업) */
    double scas_roll_pid_out_hi;        /* 출력·적분기 클램프 상한 (안티와인드업) */
    double scas_roll_sat_lo;            /* 하한 */
    double scas_roll_sat_hi;            /* 상한 */
