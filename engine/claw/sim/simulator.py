...
_CHAIN_SIGNALS = (
    ...
    "alloc_roll_hi", "alloc_pitch_hi", "alloc_resv",  # 엘레본 배분 예산 (평가 카드 ⑦ 잔여 권한)
...
class Simulator:
    ...
    def _command_clamps(self) -> dict:
        ...
        함께 다녀야 한다. 적분기 클램프 = PID 출력 한계 (축 Saturation과 수치는
        같으나 레이트 항이 밖에서 더해져 같은 사건은 아니다 — 안티와인드업은 조건부 적분,
